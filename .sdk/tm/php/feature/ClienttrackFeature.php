...
// Brasil SDK clienttrack feature
...
class BrasilClienttrackFeature extends BrasilBaseFeature
{
    ...
    public function PostConstruct(BrasilContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Brasil-SDK';
