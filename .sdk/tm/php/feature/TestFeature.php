...
// Brasil SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class BrasilTestFeature extends BrasilBaseFeature
{
    ...
    public function init(BrasilContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (BrasilContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (BrasilContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(BrasilContext $ctx, $op, $args): array
    {
