...
class BrasilTimeoutFeature extends BrasilBaseFeature
{
    ...
    private function _with_timeout(BrasilContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(BrasilContext $_ctx, float $ms): void
    {
        $client = $this->client;
