...
class BrasilStreamingFeature extends BrasilBaseFeature
{
    ...
    private function _iterate(BrasilResult $result): \Generator
    {
    ...
    private function _streamable(BrasilContext $ctx): bool
    {
