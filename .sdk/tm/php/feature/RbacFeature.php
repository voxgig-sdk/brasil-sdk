...
class BrasilRbacFeature extends BrasilBaseFeature
{
    ...
    private function _required(BrasilContext $ctx): ?string
    {
    ...
    private function _reject(BrasilContext $ctx, string $required): void
    {
    ...
    private function _track(BrasilContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
