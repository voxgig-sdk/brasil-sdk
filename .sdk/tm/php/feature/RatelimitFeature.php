...
class BrasilRatelimitFeature extends BrasilBaseFeature
{
    ...
    private function _acquire(BrasilContext $ctx): void
    {
    ...
    private function _track(BrasilContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
