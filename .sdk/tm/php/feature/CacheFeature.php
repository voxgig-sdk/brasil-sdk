...
class BrasilCacheFeature extends BrasilBaseFeature
{
    ...
    private function _through(BrasilContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
