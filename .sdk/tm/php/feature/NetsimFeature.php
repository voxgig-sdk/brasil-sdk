...
class BrasilNetsimFeature extends BrasilBaseFeature
{
    ...
    private function _simulate(BrasilContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(BrasilContext $ctx, array $applied): void
    {
        $client = $this->client;
