...
// Brasil SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = BrasilOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(BrasilOmni::structfix($now, Struct::undef()))
                        !== json_encode(BrasilOmni::structfix($val, Struct::undef()))) {
