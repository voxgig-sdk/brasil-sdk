...
// Brasil SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class BrasilMakeRequest
{
    public static function call(BrasilContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new BrasilResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new BrasilResponse($fetched);
        } else {
