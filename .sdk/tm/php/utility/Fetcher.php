...
class BrasilFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; BrasilSDK/1.0)';
    ...
    public static function call(BrasilContext $ctx, string $fullurl, array $fetchdef): array
    {
