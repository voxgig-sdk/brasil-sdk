...
class BrasilTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = BrasilTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = BrasilTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = BrasilTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
