...
|---|---|---|
| `ts/` | @voxgig-sdk/brasil-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/brasil-sdk \
      --repository voxgig-sdk/brasil-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/brasil-sdk` shows it, and
`npm trust revoke @voxgig-sdk/brasil-sdk --id=<id>` removes it.
