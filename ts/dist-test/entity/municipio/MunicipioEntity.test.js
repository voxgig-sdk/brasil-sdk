...
(0, node_test_1.describe)('MunicipioEntity', async () => {
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/municipio/MunicipioTestData.json');
    ...
    let idmap = transform(['municipio01', 'municipio02', 'municipio03', 'v101', 'v102', 'v103'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=MunicipioEntity.test.js.map