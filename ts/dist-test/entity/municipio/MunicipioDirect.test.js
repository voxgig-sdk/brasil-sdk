...
(0, node_test_1.describe)('MunicipioDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-municipio', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-municipio', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['BRASIL_TEST_MUNICIPIO_ENTID'];
...
//# sourceMappingURL=MunicipioDirect.test.js.map