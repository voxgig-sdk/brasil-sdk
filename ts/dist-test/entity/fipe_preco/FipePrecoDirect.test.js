...
(0, node_test_1.describe)('FipePrecoDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-fipe_preco', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-fipe_preco', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['BRASIL_TEST_FIPE_PRECO_ENTID'];
...
//# sourceMappingURL=FipePrecoDirect.test.js.map