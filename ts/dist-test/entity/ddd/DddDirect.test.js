...
(0, node_test_1.describe)('DddDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-ddd', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-ddd', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['BRASIL_TEST_DDD_ENTID'];
...
//# sourceMappingURL=DddDirect.test.js.map