...
(0, node_test_1.describe)('FipeMarcaDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-fipe_marca', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-fipe_marca', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['BRASIL_TEST_FIPE_MARCA_ENTID'];
...
//# sourceMappingURL=FipeMarcaDirect.test.js.map