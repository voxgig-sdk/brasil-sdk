...
(0, node_test_1.describe)('BankDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-bank', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-bank', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-bank', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-bank', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function liveScenariosActive() { return false && process.env.BRASIL_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.BrasilSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['BRASIL_TEST_BANK_ENTID'];
    ...
    const client = new __1.BrasilSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=BankDirect.test.js.map