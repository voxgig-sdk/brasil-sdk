...
(0, node_test_1.describe)('CnpjEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'cnpj.' + op, live))
                return;
        }
        ...
        let cnpj_ref01_data = Object.values(setup.data.existing.cnpj)[0];
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/cnpj/CnpjTestData.json');
    ...
    let idmap = transform(['cnpj01', 'cnpj02', 'cnpj03', 'v101', 'v102', 'v103'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['BRASIL_TEST_CNPJ_ENTID'];
...
//# sourceMappingURL=CnpjEntity.test.js.map