...
describe("DddDirect", function()
  it("should direct-load-ddd", function()
    local setup = ddd_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-ddd", setup.live and "live" or "unit")
...
function ddd_direct_setup(mockres)
