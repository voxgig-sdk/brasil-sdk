...
describe("FipePrecoDirect", function()
  it("should direct-load-fipe_preco", function()
    local setup = fipe_preco_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-fipe_preco", setup.live and "live" or "unit")
...
function fipe_preco_direct_setup(mockres)
