...
describe("CepDirect", function()
  it("should direct-load-cep", function()
    local setup = cep_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-cep", setup.live and "live" or "unit")
...
function cep_direct_setup(mockres)
