...
describe("MunicipioDirect", function()
  it("should direct-load-municipio", function()
    local setup = municipio_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-municipio", setup.live and "live" or "unit")
...
function municipio_direct_setup(mockres)
