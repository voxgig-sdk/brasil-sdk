...
describe("CnpjDirect", function()
  it("should direct-load-cnpj", function()
    local setup = cnpj_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-cnpj", setup.live and "live" or "unit")
...
function cnpj_direct_setup(mockres)
