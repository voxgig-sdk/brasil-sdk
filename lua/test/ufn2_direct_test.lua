...
describe("Ufn2Direct", function()
  it("should direct-load-ufn2", function()
    local setup = ufn2_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-ufn2", setup.live and "live" or "unit")
...
function ufn2_direct_setup(mockres)
