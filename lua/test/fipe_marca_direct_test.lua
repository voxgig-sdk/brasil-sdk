...
describe("FipeMarcaDirect", function()
  it("should direct-load-fipe_marca", function()
    local setup = fipe_marca_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-fipe_marca", setup.live and "live" or "unit")
...
function fipe_marca_direct_setup(mockres)
