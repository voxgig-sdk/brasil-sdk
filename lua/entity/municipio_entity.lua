...
local MunicipioEntity = {}
MunicipioEntity.__index = MunicipioEntity


function MunicipioEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, MunicipioEntity)
  self._name = "municipio"
  self._client = client
...
function MunicipioEntity:get_name()
  return self._name
end


function MunicipioEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return MunicipioEntity.new(self._client, opts)
end
...
function MunicipioEntity:mark_deleted()
  self._deleted = true
end


function MunicipioEntity:deleted()
  return true == self._deleted
end


function MunicipioEntity:data_set(args)
  if args ~= nil then
...
function MunicipioEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function MunicipioEntity:match_set(args)
  if args ~= nil then
...
function MunicipioEntity:match_get()
...
function MunicipioEntity:stream(action, args, callopts)
...
---@param reqmatch MunicipioLoadMatch
---@param ctrl? table
---@return Municipio
---@return string? err
function MunicipioEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function MunicipioEntity:_run_op(ctx, post_done)
  local utility = self._utility
