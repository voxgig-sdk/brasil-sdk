...
class DddEntity
  ...
  # @return [Ddd, Hash] the current Ddd data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Ddd fields)
  def match_get
  ...
  # Load a single Ddd.
  #
  # @param reqmatch [DddLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Ddd.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Ddd, Hash] the loaded Ddd; raises BrasilError on failure
