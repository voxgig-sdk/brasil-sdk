...
class MunicipioEntity
  ...
  def make
    opts = @_entopts.dup
    MunicipioEntity.new(@_client, opts)
  end
  ...
  # @return [Municipio, Hash] the current Municipio data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Municipio fields)
  def match_get
  ...
  #
  # @param reqmatch [MunicipioLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Municipio.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Municipio, Hash] the loaded Municipio; raises BrasilError on failure
