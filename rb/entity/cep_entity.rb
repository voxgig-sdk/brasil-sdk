...
class CepEntity
  ...
  # @return [Cep, Hash] the current Cep data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Cep fields)
  def match_get
  ...
  # Load a single Cep.
  #
  # @param reqmatch [CepLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Cep.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Cep, Hash] the loaded Cep; raises BrasilError on failure
