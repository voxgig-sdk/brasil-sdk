...
class FipePrecoEntity
  ...
  def make
    opts = @_entopts.dup
    FipePrecoEntity.new(@_client, opts)
  end
  ...
  # @return [FipePreco, Hash] the current FipePreco data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of FipePreco fields)
  def match_get
  ...
  #
  # @param reqmatch [FipePrecoLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.FipePreco.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [FipePreco, Hash] the loaded FipePreco; raises BrasilError on failure
