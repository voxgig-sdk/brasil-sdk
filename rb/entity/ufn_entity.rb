...
class UfnEntity
  ...
  # @return [Ufn, Hash] the current Ufn data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Ufn fields)
  def match_get
  ...
  # Load a single Ufn.
  #
  # @param reqmatch [UfnLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Ufn.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Ufn, Hash] the loaded Ufn; raises BrasilError on failure
  ...
  #
  # @param reqmatch [UfnListMatch, Hash, nil] match filter (any subset of
  #   Ufn fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Ufn>, Array] the matching Ufn items; raises BrasilError on failure
