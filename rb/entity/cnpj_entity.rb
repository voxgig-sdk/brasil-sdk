...
class CnpjEntity
  ...
  # @return [Cnpj, Hash] the current Cnpj data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Cnpj fields)
  def match_get
  ...
  # Load a single Cnpj.
  #
  # @param reqmatch [CnpjLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Cnpj.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Cnpj, Hash] the loaded Cnpj; raises BrasilError on failure
