...
module BrasilTestRunner
  ...
  def self.env_override(m)
    live = getenv("BRASIL_TEST_LIVE")
    override = getenv("BRASIL_TEST_OVERRIDE")
    ...
    explain = getenv("BRASIL_TEST_EXPLAIN")
    m["BRASIL_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = BrasilTestRunner
Helpers = BrasilHelpers
Vs = VoxgigStruct
