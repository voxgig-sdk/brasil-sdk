...
func registerSDKWords(r *eng.Registry, client *sdk.BrasilSDK) {
...
func runOp(client *sdk.BrasilSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
