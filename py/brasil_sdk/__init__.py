...
from brasil_sdk.utility import register

# Load features
from brasil_sdk.feature.base_feature import BrasilBaseFeature
from brasil_sdk.features import _has_feature, _make_feature
...
class BrasilSDK:
    ...
    def __init__(self, options=None):
        ...
        from brasil_sdk.config import shared_config
    ...
    def _op_denied(self, op):
        ...
        return {
            "ok": False,
            "err": Exception(
                "BrasilSDK: " + op + ": operation not allowed by"
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("BrasilSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Feriado(self, data=None) -> "FeriadoEntity":
        ...
        from brasil_sdk.entity.feriado_entity import FeriadoEntity
    ...
    def FipeMarca(self, data=None) -> "FipeMarcaEntity":
        ...
        from brasil_sdk.entity.fipe_marca_entity import FipeMarcaEntity
    ...
    def FipePreco(self, data=None) -> "FipePrecoEntity":
        ...
        from brasil_sdk.entity.fipe_preco_entity import FipePrecoEntity
