...
from brasil_sdk.core.control import BrasilControl
...
from brasil_sdk.core.helpers import get_ctx_prop, to_map
...
class BrasilContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(rp, BrasilResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return BrasilError(code, msg, self)
