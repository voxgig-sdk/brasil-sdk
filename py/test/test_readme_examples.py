# Brasil SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions BrasilSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both BrasilSDK(...) and BrasilSDK.test(...) become
#      BrasilSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "brasil_sdk"
_SDK_CLASS = "BrasilSDK"
