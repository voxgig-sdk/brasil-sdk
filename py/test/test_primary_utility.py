...
from brasil_sdk.core.spec import BrasilSpec
from brasil_sdk.core.result import BrasilResult
from brasil_sdk.core.response import BrasilResponse
from brasil_sdk.core.operation import BrasilOperation
from brasil_sdk.core.error import BrasilError
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = BrasilSDK.test(None, None)
        ...
        class TestInitFeature(BrasilBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(BrasilBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = BrasilSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = BrasilSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = BrasilSDK.test(None, setup_opts)
