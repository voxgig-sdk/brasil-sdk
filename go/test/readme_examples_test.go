...
const testSeed = `map[string]any{"entity": map[string]any{"bank": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "cep": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "cnpj": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "ddd": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "feriado": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "fipe_marca": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "fipe_preco": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "municipio": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "ufn": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "ufn2": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
