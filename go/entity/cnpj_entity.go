...
func NewCnpjEntity(client *core.BrasilSDK, entopts map[string]any) *CnpjEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CnpjEntity) GetName() string { return e.name }
...
func (e *CnpjEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CnpjEntity) Deleted() bool {
	return e.deleted
}


func (e *CnpjEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCnpjEntity(e.client, opts)
}

func (e *CnpjEntity) Data(args ...any) any {
...
func (e *CnpjEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Cnpj; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CnpjEntity) DataTyped(data ...Cnpj) Cnpj {
	if len(data) > 0 {
		return typedFrom[Cnpj](e.Data(asMap(data[0])))
	}
	return typedFrom[Cnpj](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Cnpj (all fields
// optional at the wire level).
func (e *CnpjEntity) MatchTyped(match ...Cnpj) Cnpj {
	if len(match) > 0 {
		return typedFrom[Cnpj](e.Match(asMap(match[0])))
	}
	return typedFrom[Cnpj](e.Match())
}
...
func (e *CnpjEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CnpjEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CnpjLoadMatch and returns an Cnpj. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *CnpjEntity) LoadTyped(reqmatch CnpjLoadMatch, ctrl map[string]any) (Cnpj, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Cnpj{}, err
	}
	return typedFrom[Cnpj](res), nil
}



func (e *CnpjEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *CnpjEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *CnpjEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CnpjEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CnpjEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
