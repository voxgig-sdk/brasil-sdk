...
func NewBankEntity(client *core.BrasilSDK, entopts map[string]any) *BankEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *BankEntity) GetName() string { return e.name }
...
func (e *BankEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *BankEntity) Deleted() bool {
	return e.deleted
}


func (e *BankEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewBankEntity(e.client, opts)
}

func (e *BankEntity) Data(args ...any) any {
...
func (e *BankEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Bank; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *BankEntity) DataTyped(data ...Bank) Bank {
	if len(data) > 0 {
		return typedFrom[Bank](e.Data(asMap(data[0])))
	}
	return typedFrom[Bank](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Bank (all fields
// optional at the wire level).
func (e *BankEntity) MatchTyped(match ...Bank) Bank {
	if len(match) > 0 {
		return typedFrom[Bank](e.Match(asMap(match[0])))
	}
	return typedFrom[Bank](e.Match())
}
...
func (e *BankEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *BankEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// BankLoadMatch and returns an Bank. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *BankEntity) LoadTyped(reqmatch BankLoadMatch, ctrl map[string]any) (Bank, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Bank{}, err
	}
	return typedFrom[Bank](res), nil
}




func (e *BankEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// BankListMatch and returns []Bank. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *BankEntity) ListTyped(reqmatch BankListMatch, ctrl map[string]any) ([]Bank, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Bank](res), nil
}



func (e *BankEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *BankEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *BankEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *BankEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
