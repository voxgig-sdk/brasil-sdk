...
func NewFipePrecoEntity(client *core.BrasilSDK, entopts map[string]any) *FipePrecoEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *FipePrecoEntity) GetName() string { return e.name }
...
func (e *FipePrecoEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *FipePrecoEntity) Deleted() bool {
	return e.deleted
}


func (e *FipePrecoEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewFipePrecoEntity(e.client, opts)
}

func (e *FipePrecoEntity) Data(args ...any) any {
...
func (e *FipePrecoEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an FipePreco; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *FipePrecoEntity) DataTyped(data ...FipePreco) FipePreco {
	if len(data) > 0 {
		return typedFrom[FipePreco](e.Data(asMap(data[0])))
	}
	return typedFrom[FipePreco](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through FipePreco (all fields
// optional at the wire level).
func (e *FipePrecoEntity) MatchTyped(match ...FipePreco) FipePreco {
	if len(match) > 0 {
		return typedFrom[FipePreco](e.Match(asMap(match[0])))
	}
	return typedFrom[FipePreco](e.Match())
}
...
func (e *FipePrecoEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *FipePrecoEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// FipePrecoLoadMatch and returns an FipePreco. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *FipePrecoEntity) LoadTyped(reqmatch FipePrecoLoadMatch, ctrl map[string]any) (FipePreco, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return FipePreco{}, err
	}
	return typedFrom[FipePreco](res), nil
}



func (e *FipePrecoEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *FipePrecoEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *FipePrecoEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *FipePrecoEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *FipePrecoEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
