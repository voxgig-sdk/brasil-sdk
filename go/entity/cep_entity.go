...
func NewCepEntity(client *core.BrasilSDK, entopts map[string]any) *CepEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CepEntity) GetName() string { return e.name }
...
func (e *CepEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CepEntity) Deleted() bool {
	return e.deleted
}


func (e *CepEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCepEntity(e.client, opts)
}

func (e *CepEntity) Data(args ...any) any {
...
func (e *CepEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Cep; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CepEntity) DataTyped(data ...Cep) Cep {
	if len(data) > 0 {
		return typedFrom[Cep](e.Data(asMap(data[0])))
	}
	return typedFrom[Cep](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Cep (all fields
// optional at the wire level).
func (e *CepEntity) MatchTyped(match ...Cep) Cep {
	if len(match) > 0 {
		return typedFrom[Cep](e.Match(asMap(match[0])))
	}
	return typedFrom[Cep](e.Match())
}
...
func (e *CepEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CepEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CepLoadMatch and returns an Cep. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *CepEntity) LoadTyped(reqmatch CepLoadMatch, ctrl map[string]any) (Cep, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Cep{}, err
	}
	return typedFrom[Cep](res), nil
}



func (e *CepEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *CepEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *CepEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CepEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CepEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
