...
func NewUfnEntity(client *core.BrasilSDK, entopts map[string]any) *UfnEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *UfnEntity) GetName() string { return e.name }
...
func (e *UfnEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *UfnEntity) Deleted() bool {
	return e.deleted
}


func (e *UfnEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewUfnEntity(e.client, opts)
}

func (e *UfnEntity) Data(args ...any) any {
...
func (e *UfnEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Ufn; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *UfnEntity) DataTyped(data ...Ufn) Ufn {
	if len(data) > 0 {
		return typedFrom[Ufn](e.Data(asMap(data[0])))
	}
	return typedFrom[Ufn](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Ufn (all fields
// optional at the wire level).
func (e *UfnEntity) MatchTyped(match ...Ufn) Ufn {
	if len(match) > 0 {
		return typedFrom[Ufn](e.Match(asMap(match[0])))
	}
	return typedFrom[Ufn](e.Match())
}
...
func (e *UfnEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *UfnEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// UfnLoadMatch and returns an Ufn. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *UfnEntity) LoadTyped(reqmatch UfnLoadMatch, ctrl map[string]any) (Ufn, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Ufn{}, err
	}
	return typedFrom[Ufn](res), nil
}




func (e *UfnEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// UfnListMatch and returns []Ufn. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *UfnEntity) ListTyped(reqmatch UfnListMatch, ctrl map[string]any) ([]Ufn, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Ufn](res), nil
}



func (e *UfnEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *UfnEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *UfnEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *UfnEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
