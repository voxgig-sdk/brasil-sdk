...
func NewDddEntity(client *core.BrasilSDK, entopts map[string]any) *DddEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *DddEntity) GetName() string { return e.name }
...
func (e *DddEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *DddEntity) Deleted() bool {
	return e.deleted
}


func (e *DddEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewDddEntity(e.client, opts)
}

func (e *DddEntity) Data(args ...any) any {
...
func (e *DddEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Ddd; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *DddEntity) DataTyped(data ...Ddd) Ddd {
	if len(data) > 0 {
		return typedFrom[Ddd](e.Data(asMap(data[0])))
	}
	return typedFrom[Ddd](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Ddd (all fields
// optional at the wire level).
func (e *DddEntity) MatchTyped(match ...Ddd) Ddd {
	if len(match) > 0 {
		return typedFrom[Ddd](e.Match(asMap(match[0])))
	}
	return typedFrom[Ddd](e.Match())
}
...
func (e *DddEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *DddEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// DddLoadMatch and returns an Ddd. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *DddEntity) LoadTyped(reqmatch DddLoadMatch, ctrl map[string]any) (Ddd, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Ddd{}, err
	}
	return typedFrom[Ddd](res), nil
}



func (e *DddEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *DddEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *DddEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *DddEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *DddEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
