...
The Golang SDK for the Brasil API. Provides an entity-oriented interface using standard Go conventions — no generics required, data flows as `map[string]any`.


## Install
```bash
go get github.com/voxgig-sdk/brasil-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/brasil-sdk=../path/to/github.com/voxgig-sdk/brasil-sdk
```
...
```
github.com/voxgig-sdk/brasil-sdk/
...
The root package (`github.com/voxgig-sdk/brasil-sdk`) re-exports everything needed
