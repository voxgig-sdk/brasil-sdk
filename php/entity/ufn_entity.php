...
class UfnEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new UfnEntity($this->_client, $opts);
    }

    /**
     * @param Ufn|array $args Ufn data (assoc-array) to store.
     */
    ...
    /**
     * @return Ufn|array The current Ufn data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Ufn fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Ufn fields).
     */
     ...
     * Load a single Ufn.
     *
     * @param UfnLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed UfnLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Ufn|array The loaded Ufn as an assoc-array at the
    ...
    /**
     * List Ufn items matching the given filter.
     *
     * @param UfnListMatch|array|null $reqmatch Match filter (any subset
     *   of Ufn fields) as an assoc-array; UfnListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Ufn[]|array A list of Ufn items as assoc-arrays at
