...
class CepEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new CepEntity($this->_client, $opts);
    }

    /**
     * @param Cep|array $args Cep data (assoc-array) to store.
     */
    ...
    /**
     * @return Cep|array The current Cep data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Cep fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Cep fields).
     */
     ...
     * Load a single Cep.
     *
     * @param CepLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed CepLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Cep|array The loaded Cep as an assoc-array at the
