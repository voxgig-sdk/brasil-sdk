...
class DddEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new DddEntity($this->_client, $opts);
    }

    /**
     * @param Ddd|array $args Ddd data (assoc-array) to store.
     */
    ...
    /**
     * @return Ddd|array The current Ddd data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Ddd fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Ddd fields).
     */
     ...
     * Load a single Ddd.
     *
     * @param DddLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed DddLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Ddd|array The loaded Ddd as an assoc-array at the
