...
class BrasilProxyFeature extends BrasilBaseFeature
{
    ...
    public function init(BrasilContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (BrasilContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
