...
class FipePrecoDirectTest extends TestCase
{
    public function test_direct_load_fipe_preco(): void
    {
        $setup = fipe_preco_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-fipe_preco", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
