...
class CnpjDirectTest extends TestCase
{
    public function test_direct_load_cnpj(): void
    {
        $setup = cnpj_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-cnpj", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
