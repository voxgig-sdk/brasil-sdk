...
class Ufn2DirectTest extends TestCase
{
    public function test_direct_load_ufn2(): void
    {
        $setup = ufn2_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-ufn2", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
