...
class BrasilTestRunner
{
    ...
    {
        $live = self::getenv('BRASIL_TEST_LIVE');
        $override = self::getenv('BRASIL_TEST_OVERRIDE');
        ...
        $explain = self::getenv('BRASIL_TEST_EXPLAIN');
...
class_alias('BrasilTestRunner', 'Runner');
class_alias('BrasilHelpers', 'Helpers');
