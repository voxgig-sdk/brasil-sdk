...
// Brasil SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (BrasilSDK::test)
...
{
    private const SDK_CLASS = 'BrasilSDK';
    ...
    private const SDK_BASE = 'brasil_sdk';
